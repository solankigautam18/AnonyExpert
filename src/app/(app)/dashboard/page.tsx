...
const Page = () => {
  ...
  if(!session || !session.user){
    return <div
    className="text-center mt-10 text-2xl font-bold">
  ...
  const profileUrl = `${baseUrl}/pstGems/${username}`;
...
// 
  ...
  return (
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
      ...
      <Button className="mt-4" variant="outline" onClick={(e) => {e.preventDefault
        ();
        fetchMessages(true);
      }}
      >
...
// https://github.com/solankigautam18/AnonyExpert.git