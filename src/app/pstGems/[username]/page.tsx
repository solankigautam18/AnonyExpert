...
//     } 
//     try {
//       const response = await axios.post('/api/send-messages', {message, userId: user._id})
...
//       <h1 className="text-5xl text-center font-bold mb-2">Public Profile Link</h1>
//       <p className="text-md  font-semibold mb-2 mt-5">Send anonymous message to @{user?.username || user?.email} </p>
//       <Textarea placeholder='Write your anonymous message here' value={message} onChange={(e) => setMessage(e.target.value)}/>

//       <Button className="mt-4" variant="default" onClick={handleSubmit}>Send</Button>
//     </div>
